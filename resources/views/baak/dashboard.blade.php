                        ...
                        <tr class="hover:bg-slate-50/40 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                @if($pengajuan->file_dokumen_pendukung)
                                    <a href="{{ asset('storage/' . $pengajuan->file_dokumen_pendukung) }}"
                                       target="_blank"
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @else
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-extrabold tracking-wide rounded-full border
                                            {{ $pengajuan->status === 'approved' ? 'bg-emerald-50 text-emerald-600 border-emerald-200/50' : 'bg-rose-50 text-rose-600 border-rose-200/50' }}">
