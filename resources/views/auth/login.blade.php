                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 text-xs font-semibold text-slate-600 select-none">Ingat
                                saya</label>
                        </div>
                        <a href="#" class="text-xs font-bold text-blue-600 hover:text-blue-700 transition-colors">Lupa
                            Password?</a>
                    </div>

                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 active:scale-[0.98] rounded-xl text-sm font-bold text-white shadow-md shadow-slate-900/10 hover:shadow-lg transition-all duration-200 mt-2">
                        Masuk ke Dashboard
                    </button>
                </form>
