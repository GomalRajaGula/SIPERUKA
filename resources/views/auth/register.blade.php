        ...
        <div class="lg:col-span-7 bg-white flex items-center justify-center p-8 md:p-12 lg:p-16">
            <div class="w-full max-w-md space-y-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-1">Lengkapi informasi di bawah ini untuk membuat akun baru Anda.</p>
                </div>
                ...
                <div class="relative flex py-2 items-center">
                    ...
                    <span class="flex-shrink mx-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Atau Daftar Manual</span>
                    <div class="flex-grow border-t border-slate-100"></div>
                </div>
                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.333 0 4 .667 4 2v1H5v-1c0-1.333 2.667-2 2-2z"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 active:scale-[0.98] rounded-xl text-sm font-bold text-white shadow-md shadow-slate-900/10 hover:shadow-lg transition-all duration-200 mt-4 uppercase">
                        Daftar
                    </button>
                </form>
                ...
                <p class="text-center text-xs text-slate-500 mt-4">
                    Sudah punya akun? <a href="/login" class="font-bold text-blue-600 hover:text-blue-700 transition-colors">Login sekarang!</a>
                </p>
            </div>
        </div>
