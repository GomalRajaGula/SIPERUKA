                                ...
                                @if($pengajuan->status === 'approved')
                                    <div class="flex flex-col gap-1">
                                        ...
                                        @if($pengajuan->file_dokumen_pendukung)
                                            <a href="{{ route('mahasiswa.pengajuan.surat-izin', $pengajuan->id) }}" target="_blank" class="inline-flex items-center gap-1 text-xxs font-bold text-blue-600 hover:text-blue-700 mt-1 transition-colors">
